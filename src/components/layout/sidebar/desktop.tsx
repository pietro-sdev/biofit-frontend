...
import { Home, Users, Settings, CreditCard, ListMinus, Bell, LogOut } from "lucide-react";
        ...
        <aside className="fixed inset-y-0 left-0 z-10 hidden w-14 border-r bg-background sm:flex flex-col">
            <nav className="flex flex-col items-center gap-4 px-2 py-5">
                <TooltipProvider>
                    ...
                    >
                        <Avatar>
                            <AvatarImage src="https://avatars.githubusercontent.com/u/185261089?v=4" alt="BlockCode" />
